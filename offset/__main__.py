...
def _build_parser(parser):
    ...
    parser.add_argument('--dns-name', '--ip', dest='hostname', help='Location of node', required=True)
    parser.add_argument('-u', '--user', help='Login username', dest='username', required=True)
    ...
    parser.add_argument('--purpose', '--cluster', dest='purpose',
